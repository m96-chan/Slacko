...
func darkTheme() Theme {
	return Theme{
		...
		MessagesList: MessagesListTheme{
			...
			AttachmentTitle:  makeStyle("#5fafd7", "", "b"),
			AttachmentText:   makeStyle("#8a8a8a", "", ""),
			AttachmentFooter: makeStyle("#585858", "", "d"),
...
func lightTheme() Theme {
	return Theme{
		...
		MessagesList: MessagesListTheme{
			...
			AttachmentTitle:  makeStyle("#0087af", "", "b"),
			AttachmentText:   makeStyle("#585858", "", ""),
			AttachmentFooter: makeStyle("#a8a8a8", "", "d"),
...
func monokaiTheme() Theme {
	return Theme{
		...
		MessagesList: MessagesListTheme{
			...
			AttachmentTitle:  makeStyle("#66d9ef", "", "b"),
			AttachmentText:   makeStyle("#75715e", "", ""),
			AttachmentFooter: makeStyle("#75715e", "", "d"),
...
func solarizedDarkTheme() Theme {
	return Theme{
		...
		MessagesList: MessagesListTheme{
			...
			AttachmentTitle:  makeStyle("#2aa198", "", "b"),
			AttachmentText:   makeStyle("#586e75", "", ""),
			AttachmentFooter: makeStyle("#586e75", "", "d"),
...
func solarizedLightTheme() Theme {
	return Theme{
		...
		MessagesList: MessagesListTheme{
			...
			FileAttachment:   makeStyle("#268bd2", "", ""),
			AttachmentTitle:  makeStyle("#2aa198", "", "b"),
			AttachmentText:   makeStyle("#93a1a1", "", ""),
			AttachmentFooter: makeStyle("#93a1a1", "", "d"),
			ReactionSelf:     makeStyle("#b58900", "", ""),
...
// highContrastTheme maximizes luminosity differences and uses bold attributes
// extensively. Designed for visually impaired users or bright environments.
func highContrastTheme() Theme {
	return Theme{
		Preset: "high_contrast",
		Border: BorderTheme{
			Focused: makeStyle("white", "", "b"),
			Normal:  makeStyle("white", "", ""),
		},
		Title: TitleTheme{
			Focused: makeStyle("white", "", "b"),
			Normal:  makeStyle("white", "", ""),
		...
		MessagesList: MessagesListTheme{
			Message:          makeStyle("white", "", ""),
			Author:           makeStyle("green", "", "b"),
			Timestamp:        makeStyle("white", "", ""),
			Selected:         makeStyle("white", "", "r"),
			Reply:            makeStyle("cyan", "", "b"),
			SystemMessage:    makeStyle("white", "", "d"),
			EditedIndicator:  makeStyle("white", "", "d"),
			PinIndicator:     makeStyle("yellow", "", "b"),
			FileAttachment:   makeStyle("cyan", "", "b"),
			AttachmentTitle:  makeStyle("cyan", "", "b"),
			AttachmentText:   makeStyle("white", "", ""),
			AttachmentFooter: makeStyle("white", "", "d"),
			ReactionSelf:     makeStyle("yellow", "", "b"),
			ReactionOther:    makeStyle("white", "", "b"),
			DateSeparator:    makeStyle("white", "", "b"),
			NewMsgSeparator:  makeStyle("red", "", "b"),
		},
		MessageInput: MessageInputTheme{
			Text:        makeStyle("white", "", ""),
			Placeholder: makeStyle("white", "", "d"),
		},
		ThreadView: ThreadViewTheme{
			Author:           makeStyle("green", "", "b"),
			Timestamp:        makeStyle("white", "", ""),
			ParentLabel:      makeStyle("white", "", "b"),
			Separator:        makeStyle("white", "", "b"),
			EditedIndicator:  makeStyle("white", "", "d"),
			FileAttachment:   makeStyle("cyan", "", "b"),
			AttachmentTitle:  makeStyle("cyan", "", "b"),
			AttachmentText:   makeStyle("white", "", ""),
			AttachmentFooter: makeStyle("white", "", "d"),
			Reaction:         makeStyle("white", "", "b"),
		},
		Markdown: MarkdownTheme{
			UserMention:    makeStyle("yellow", "", "b"),
			ChannelMention: makeStyle("cyan", "", "b"),
			SpecialMention: makeStyle("yellow", "", "bu"),
			Link:           makeStyle("cyan", "", "bu"),
			InlineCode:     makeStyle("white", "", "r"),
			CodeFence:      makeStyle("white", "", "r"),
			BlockquoteMark: makeStyle("white", "", "b"),
			BlockquoteText: makeStyle("white", "", ""),
		},
		Modal: ModalTheme{
			InputBackground: makeStyle("", "", ""),
			SecondaryText:   makeStyle("white", "", ""),
		},
		StatusBar: StatusBarTheme{
			Text:       makeStyle("white", "", "b"),
			Background: makeStyle("", "blue", ""),
		},
	}
}

// monochromeTheme uses no colors — only attributes (bold, dim, underline,
// reverse) for differentiation. Works on any terminal including 1-color.
func monochromeTheme() Theme {
	return Theme{
		...
		MessagesList: MessagesListTheme{
			Message:          makeStyle("", "", ""),
			Author:           makeStyle("", "", "b"),
			Timestamp:        makeStyle("", "", "d"),
			Selected:         makeStyle("", "", "r"),
			Reply:            makeStyle("", "", "u"),
			SystemMessage:    makeStyle("", "", "d"),
			EditedIndicator:  makeStyle("", "", "d"),
			PinIndicator:     makeStyle("", "", "b"),
			FileAttachment:   makeStyle("", "", "u"),
			AttachmentTitle:  makeStyle("", "", "bu"),
			AttachmentText:   makeStyle("", "", "d"),
			AttachmentFooter: makeStyle("", "", "d"),
			ReactionSelf:     makeStyle("", "", "b"),
			ReactionOther:    makeStyle("", "", ""),
			DateSeparator:    makeStyle("", "", "d"),
			NewMsgSeparator:  makeStyle("", "", "b"),
		},
		MessageInput: MessageInputTheme{
			Text:        makeStyle("", "", ""),
			Placeholder: makeStyle("", "", "d"),
		},
		ThreadView: ThreadViewTheme{
			Author:           makeStyle("", "", "b"),
			Timestamp:        makeStyle("", "", "d"),
			ParentLabel:      makeStyle("", "", "d"),
			Separator:        makeStyle("", "", "d"),
			EditedIndicator:  makeStyle("", "", "d"),
			FileAttachment:   makeStyle("", "", "u"),
			AttachmentTitle:  makeStyle("", "", "bu"),
			AttachmentText:   makeStyle("", "", "d"),
		...
		Markdown: MarkdownTheme{
			UserMention:    makeStyle("", "", "b"),
			ChannelMention: makeStyle("", "", "b"),
			SpecialMention: makeStyle("", "", "bu"),
			Link:           makeStyle("", "", "u"),
			InlineCode:     makeStyle("", "", "r"),
			CodeFence:      makeStyle("", "", "r"),
			BlockquoteMark: makeStyle("", "", "d"),
			BlockquoteText: makeStyle("", "", "d"),
		},
		Modal: ModalTheme{
			InputBackground: makeStyle("", "", ""),
			SecondaryText:   makeStyle("", "", "d"),
		},
		StatusBar: StatusBarTheme{
			Text:       makeStyle("", "", "b"),
			Background: makeStyle("", "", "r"),
		},
	}
}
